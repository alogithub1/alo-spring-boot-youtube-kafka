...
Note: The numbers like 1,2,3,4 listed in the above diagram is for running these services in a sequential order so that all pieces will work together, other than that it does not add any value.
